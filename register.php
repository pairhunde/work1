	...
	<head>
		...
		?>
								<form method="POST" action="register_config.php">
                                    ...
                                    <br>
									<div class="switch-wrap d-flex justify-content-between col-lg-10 col-sm-8">
                                            <div class="confirm-checkbox">
                                                <input type="checkbox" id="confirm-checkbox" required>
                                                <label for="confirm-checkbox"></label>
                                            </div>
                                            <span class="text-left">I agree to the Term and condution?</span>
                                        </div>
								<hr> 
                                <div class="mt-10">
						...
						<button type="submit" class="genric-btn primary circle arrow">Register<span class="lnr lnr-arrow-right"></span></button>
