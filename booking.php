				...
				<div class="section-top-border">
						<div class="row">
							<div class="col-lg-6 col-md-6">
                                <hr>
										<h3 class="mb-30">Book Course</h3>
												<script src="https://js.paystack.co/v1/inline.js"></script>
												<div id="paystackEmbedContainer"></div>
												
												<script>
													PaystackPop.setup({
													 key: 'pk_live_fdc3664a70912aa86ba0f17cfa6d732bb25c8d52',
					...
					<br>
								<blockquote class="generic-blockquote">
									...
									<h5 class="mb-18">Intense Web Design and Development Courses
											<br>Diploma in Web Design</h5>
											<br>
											<p>Course Code: </p>
											<p>Course Calender</p>
								</blockquote>
						...
						<img src="img/IMG_3226.PNG" width="60%" heigth="18">
					</div>
